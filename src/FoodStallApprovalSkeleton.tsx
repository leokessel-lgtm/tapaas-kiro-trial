...
export function FoodStallApprovalSkeleton() {
  ...
  return (
    <div>
      ...
      {step === 'food' && <FoodHandlingStep form={form} attempted={attempted} update={update} onBack={goBack} onContinue={goNext} onExit={handleExit} />}
...
function StallStep({ form, attempted, update, onBack, onContinue, onExit }: StepProps) {
  ...
  const eventNameErr = attempted && !form.eventName.trim()
  ...
  return (
    <section aria-labelledby='stall-heading'>
      ...
      />
      <Field id='event-name' label='Event name' hasError={eventNameErr} errorMessage='Enter the event name.'>
        <Input id='event-name' value={form.eventName} onChange={(e) => update({ eventName: e.target.value })} hasError={eventNameErr} inputWidth='xl' />
      </Field>
  ...
  return (
    <section aria-labelledby='confirmation-heading'>
      ...
      <ol className='tapaas-step-list'>
        ...
        <li>If approved, your temporary food stall approval will be issued for the event date.</li>
