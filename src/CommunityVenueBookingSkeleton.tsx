...
export function CommunityVenueBookingSkeleton() {
  const [step, setStep] = useState<VenueStep>('privacy')
  ...
  return (
    <div>
      ...
      {step === 'venue' && <VenueStep form={form} attempted={attempted} update={update} onBack={goBack} onContinue={goNext} onExit={handleExit} />}
