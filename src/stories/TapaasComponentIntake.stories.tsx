...
const candidates: ComponentCandidate[] = [
  ...
  },
  {
    ...
    nextAction: 'Select one variant per flow and confirm whether legal content may be collapsed.',
  ...
  },
  {
    ...
    nextAction: 'Use GEL accordion source behaviour only for optional guidance. Do not hide required content.',
  ...
  },
  {
    ...
    nextAction: 'Deep extract keyboard, focus, selected, error and responsive states before coding.',
  ...
  },
  {
    ...
    nextAction: 'Keep mock-only and compose with GEL Field, Input and Button unless backend lookup is explicitly in scope.',
  ...
  },
  {
    ...
    nextAction: 'Confirm action semantics, keyboard behaviour and route/focus expectations before coding.',
  },
  {
    name: 'Show more / less',
    source: '22:25082',
  ...
  },
  {
    ...
    nextAction: 'Use only with source-confirmed business rules, error codes and recovery wording.',
