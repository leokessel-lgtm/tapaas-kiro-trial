    ...
    <div className='snsw-shell'>
      ...
      <div className='snsw-utility-bar'>
        <div className='snsw-utility-bar__inner'>
          <a href='#' className='snsw-utility-bar__link'>
            <IconGlobe size={14} />
            Change language
          </a>
          <a href='#' className='snsw-utility-bar__link'>
      ...
      <header className='snsw-header'>
        <div className='snsw-header__inner'>
          <a href='#' className='snsw-header__logo' aria-label='Service NSW home'>
      ...
      <footer className='snsw-footer'>
        <div className='snsw-footer__inner'>
          <div className='snsw-footer__col'>
            <h3>Find services</h3>
            <ul>
              <li><a href='#'>Births, relationships and deaths</a></li>
              <li><a href='#'>Boating, fishing and outdoors</a></li>
              <li><a href='#'>Business, industries and employment</a></li>
              <li><a href='#'>Concessions, rebates and assistance</a></li>
              <li><a href='#'>Driving and transport</a></li>
              <li><a href='#'>Education</a></li>
              <li><a href='#'>Emergencies and natural disasters</a></li>
              <li><a href='#'>Environment, parks and wildlife</a></li>
              <li><a href='#'>Health and care</a></li>
              <li><a href='#'>Housing and property</a></li>
              <li><a href='#'>Legal and Police services</a></li>
            </ul>
          </div>
          <div className='snsw-footer__col'>
            <h3>Service NSW</h3>
            <ul>
              ...
              <li><a href='#'>Jobs at Service NSW</a></li>
              <li><a href='#'>News</a></li>
              <li><a href='#'>Service status</a></li>
              <li><a href='#'>Performance dashboard</a></li>
              <li><a href='#'>Download the Service NSW app</a></li>
              <li><a href='#'>Help in your language</a></li>
            </ul>
          </div>
          <div className='snsw-footer__col'>
            <h3>Contact</h3>
            <ul>
              ...
              <li><a href='#'>Phone 13 77 88</a></li>
              <li><a href='#'>Find a Service NSW location</a></li>
              <li><a href='#'>Find a NSW Government agency</a></li>
            </ul>
            <div className='snsw-footer__social'>
              <a href='#' className='snsw-footer__social-icon' aria-label='Facebook'>
              ...
              <a href='#' className='snsw-footer__social-icon' aria-label='LinkedIn'>
              ...
              <a href='#' className='snsw-footer__social-icon' aria-label='Instagram'>
              ...
              <a href='#' className='snsw-footer__social-icon' aria-label='YouTube'>
        ...
        <div className='snsw-footer__bottom'>
          <div className='snsw-footer__bottom-inner'>
            ...
            <a href='#'>Copyright and disclaimer</a>
            <a href='#'>Accessing information</a>
            <a href='#'>NSW Government</a>
          </div>
        </div>
      </footer>
    </div>
