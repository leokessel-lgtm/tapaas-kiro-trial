/**
 * Preview-only SVG icons extracted from @snsw-gel/ui-icons source (read-only reference).
 * These are verified SVG paths from gel-packages-source-snapshot/packages/ui-icons/src/index.tsx.
 *
 * When @snsw-gel/react is available, replace with real icon imports.
 */
...
export function IconGlobe({ size = 16, className, title }: IconProps) {
  return (
    <svg
...
export function IconAvatar({ size = 16, className, title }: IconProps) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width={size}
...
export function IconSignOut({ size = 16, className, title }: IconProps) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width={size}
...
export function IconSearch({ size = 18, className, title }: IconProps) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width={size}
...
export function IconChevronLeft({ size = 16, className, title }: IconProps) {
  return (
    <svg
      xmlns='http://www.w3.org/2000/svg'
      width={size}
