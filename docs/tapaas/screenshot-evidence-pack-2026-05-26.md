...
|---|---|---|---|
| MPS Review Frame | `A` for bounded desktop `6.A` content-frame comparison | Desktop source and coded screenshots are available for visual review of section order, section grouping, edit-control placement, declaration placement and CTA relationship. | This is not full-frame parity. Global chrome, footer, mobile parity, edit routing, submission, declaration/legal wording, policy/privacy approval and assistive-technology behaviour remain out of scope. |
...
| MPS Confirmation Frame | `A` for bounded desktop `6.A` content-frame comparison | Desktop source and coded screenshots are available for visual review of confirmation heading, support copy, reference/details area, next steps, feedback prompt and action relationship. | This is not full-frame parity. Mobile parity and `6.B` tile variant remain review-gated. Real reference format, notification timing, receipt behaviour, feedback capture, related transaction routing and assistive-technology behaviour remain out of scope. |
