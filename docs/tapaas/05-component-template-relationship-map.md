...
| Evidence checklist | MPS medical frames `4.A`/`4.Aa`/`4.B`/`4.Ba`; extracted certificate nodes `0:17316`, `0:17333`; extracted report nodes `0:17357`, `0:17370`; boundary nodes `0:17327`, `0:17344`, `0:17351`, `0:17369`, `0:17381`, `0:17384`, `0:17385`, `0:17386`; GEL file-upload/status-label evidence | Evidence and review pages | GEL/TaPaaS composition | `EvidenceChecklistCard`, `MpsMedicalEvidenceStatusPreview` | Use as mock evidence status only. Do not implement upload, remove-file behaviour, file validation, storage or progress without full GEL FileUpload review. Certificate upload-state/file-limit and report section-wording inconsistencies remain review-gated. |
