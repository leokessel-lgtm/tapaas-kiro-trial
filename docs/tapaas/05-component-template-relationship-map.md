...
| Evidence checklist | MPS medical frames `4.A`/`4.Aa`/`4.B`/`4.Ba`; extracted medical certificate nodes `0:17316`, `0:17333`; boundary nodes `0:17327`, `0:17344`, `0:17351`; GEL file-upload/status-label evidence | Evidence and review pages | GEL/TaPaaS composition | `EvidenceChecklistCard`, `MpsMedicalEvidenceStatusPreview` | Use as mock evidence status only. Do not implement upload, file validation, storage or progress without full GEL FileUpload review. Source upload-state and file-limit inconsistencies remain review-gated. |
...
| Medical documents | `4.A`/`4.B` medical certificate/report and uploaded variants; `4.A`/`4.Aa` extracted as nodes `0:17316`, `0:17333` | Evidence checklist and mock evidence pages | File upload and medical evidence handling remain mock-only. No real upload, storage or validation. `MpsMedicalEvidenceStatusPreview` covers only static required/provided status and mock file-name display. |
