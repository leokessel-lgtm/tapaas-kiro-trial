...
| MPS Review Frame fidelity story | Storybook story for `MPS Review Frame - Figma Fidelity` | Review source-backed review-page layout and mock playback. |
| MPS Confirmation Frame fidelity story | Storybook story for `MPS Confirmation Frame - Figma Fidelity` | Review source-backed confirmation layout and next-step content. |
...
| review | Aligned | MPS review frame `0:33185`; supporting legal accordion, review fees, evidence and assessment patterns | MPS review fidelity story; review/confirmation assembly; MPS end-to-end story | `ReviewStep` uses `MpsReviewFramePreview` and support components | Manifest entry for MPS review frame | Does the review layout and data playback support the intended review process, with edit routing and content still review-gated? | Designer, engineering, content/product owner, accessibility |
| confirmation | Aligned | MPS confirmation frame `0:33222`; next steps card `11:4848` | MPS confirmation fidelity story; review/confirmation assembly; MPS end-to-end story | `OutcomeStep` uses `MpsConfirmationFramePreview` | Manifest entries for confirmation frame and next steps card | Does the confirmation layout communicate the mocked outcome clearly without implying real reference, notification or receipt behaviour? | Designer, product owner, content, engineering |
...
Do not continue broad extraction until reviewers confirm which of these gaps matters most for the next trial decision.
